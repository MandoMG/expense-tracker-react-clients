  ...
  return (
    <TouchableOpacity
      ...
      <View style={commonStyles.listItemLeftColumn}>
        ...
        <Text style={commonStyles.listItemSubText}>{TextUtil.formatCurrency(item.categoryValue)}</Text>
      </View>
      <View style={commonStyles.listItemRightColumn}>
        <Text style={commonStyles.listItemMainText}>{TextUtil.formatCurrency(item.categoryBudget)}</Text>
